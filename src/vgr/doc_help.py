...
class VgrLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?i)(?<![.\w_])(:?RotateDbConnectionCredentials|GenerateDbRoleCredentials|RotateDbRoleCredentials|CreateDbConnection|UpdateDbConnection|DeleteDbConnection|CreateLdapLibrary|UpdateLdapLibrary|DeleteLdapLibrary|ListLdapLibraries|ListDbConnections|ResetDbConnection|MoveCursorToLine|DefaultNamespace|DeleteKvMetadata|UndeleteKvSecret|ReadDbConnection|MoveCursorToCol|GetTerminalSize|CreateNamespace|UpdateNamespace|DeleteNamespace|UnlockNamespace|DestroyKvSecret|ReadLdapLibrary|Continue-While|Authentication|StrikethruAttr|ListNamespaces|CreateKvSecret|ReadKvMetadata|UpdateKvSecret|DeleteKvSecret|CreateLdapRole|UpdateLdapRole|DeleteLdapRole|RotateLdapRole|Call-Function|Corresponding|RestoreCursor|CursorVisible|CursorForward|AlignmentTest|SetForeground|SetBackground|UnderlineAttr|ReadNamespace|LockNamespace|ListKvSecrets|PatchKvSecret|ListLdapRoles|End-Function|Continue-For|HTTP-Version|MoveCursorTo|GetCursorPos|EraseDisplay|ScrollRegion|SmoothScroll|SetClipboard|ClearAllTabs|ReadKvSecret|ReadLdapRole|CreateDbRole|UpdateDbRole|DeleteDbRole|Break-While|Dereference|Operational|ClearScreen|GetTermSize|RaiseWindow|SetIconName|ItalicsAttr|ReverseAttr|DHighBottom|CreateMount|UpdateMount|DeleteMount|ListDbRoles|Description|End-Repeat|End-Unless|End-Choose|Dictionary|Remove-Key|Create-Zip|Descending|Terminator|Disconnect|Parameters|Connection|Attributes|HomeCursor|SaveCursor|ShowCursor|HideCursor|CursorDown|CursorBack|InsertLine|DeleteLine|InsertChar|DeleteChar|ScrollDown|OriginMode|InsertMode|PrintDHigh|RepeatChar|ResetAttrs|HiddenAttr|DoubleWide|SingleWide|ListMounts|ReadDbRole|End-Until|End-While|Break-For|Undefined|Otherwise|Separator|Overwrite|Ascending|Delimiter|Character|Variables|Cartesian|Redirects|Parameter|Read-Only|EraseChar|EraseLine|SoftReset|HardReset|DeIconify|BlinkAttr|DrawHLine|DrawVLine|ReadMount|BlockSize|Namespace|Terminal|Encoding|Function|For-Each|Continue|IMatches|Contains|Positive|Negative|Subtract|Multiply|Includes|Markdown|No-Flush|Position|MarkDown|Template|Redirect|Password|CursorUp|EraseEOL|EraseBOL|EraseEOS|EraseBOS|ScrollUp|AutoWrap|ClearTab|SetTitle|SetStyle|BoldAttr|DHighTop|Metadata|Headers|Seconds|Declare|Compile|End-For|Greater|Matches|Contain|Defined|Through|Verbose|No-Echo|Set-Key|Include|Exhibit|Warning|Comment|Exclude|Prepend|Replace|Compact|Wrapper|Quoting|Default|Product|Request|Connect|Options|Maximum|Timeout|Aliases|DECSCNM|DimAttr|DrawBox|Results|Secrets|Version|Header|Values|Second|Giving|Output|Global|Define|End-If|Repeat|Unless|Return|Equals|IMatch|Choose|Accept|Secure|Assign|Divide|Remove|Source|Object|Assert|Printf|Record|Append|Extend|Create|Unique|Insert|Select|Sorted|Indent|Blocks|Offset|Method|Delete|Verify|Digest|Follow|Search|Filter|SetTab|Result|Secret|Config|Files|Nulls|Error|Input|Begin|Using|Local|Times|Until|While|Break|Equal|Match|Empty|Debug|Sleep|Unset|Reset|Lines|Print|Field|Flush|Level|Close|Paths|Index|First|Where|Array|Style|Jinja|Batch|Strip|Chain|Limit|Fetch|Patch|Trace|Basic|Param|Write|Attrs|Scope|Vault|Token|Block|Bytes|File|Call|Each|Next|Step|Then|Else|Time|Less|Than|Does|Even|When|Thru|Echo|Pass|From|Down|With|Swap|Data|Args|Load|Type|Text|JSON|Line|YAML|Warn|Info|Open|Read|Junk|Exit|Sort|List|Into|Item|Last|Keys|Root|Char|Auto|Trim|Left|Keep|Rows|Only|Http|Head|Post|Auth|User|Body|Ldap|Page|Size|Base|Host|Meta|End|For|Not|All|Odd|Nop|Set|Let|Add|Key|And|CSV|HCL|INI|Per|OFS|ORS|Log|Zip|Asc|Des|URL|Get|Put|SSL|Max|Are|Ver|CAS|To|Is|As|In|If|To|No|Up|By|On|At|Or)(?![.\w-])", Keyword),
            (r"(?i)\b(:?Backslash|Newline|Escape|Period|Colon|Comma|False|Quote|Space|None|Null|True|Zero|Inf|Nan|Tab|∅|∞)\b", Name.Constant),
            (r"(?i)\b(?:CountTrailingZeroBits|CountLeadingZeroBits|LdapAttrGreaterThan|ExtractAllMatches|LdapAttrNotExists|ExtractKVMetadata|IsNotGreaterThan|LdapAttrLessThan|LdapAttrNotEqual|ListRemoveFirst|MdStrikeThrough|MdUnorderedList|LdapAttrBetween|LdapAttrMatches|CompilePattern|FormatDuration|FormatDateTime|IsAlphaNumeric|ListRemoveLast|LdapAttrEquals|LdapAttrExists|CountZeroBits|DirectoryName|DoesNotIMatch|FloorMultiple|GetWeekOfYear|HighestOneBit|IsGreaterThan|IsNotLessThan|MdOrderedList|RoundMultiple|LdapFilterAnd|LdapFilterNot|ExtractKVData|Base64Decode|Base64Encode|CeilMultiple|CombineLists|CombineUsing|CountOneBits|DoesNotMatch|ExtractMatch|GetDayOfWeek|GetDayOfYear|GetMonthName|GetUtcOffset|IsDictionary|IsNotEqualTo|LowestOneBit|MdBlockQuote|RegexReplace|RemovePrefix|RemoveSuffix|ReverseBytes|RightJustify|TranslateStr|LdapFilterOr|ToLdapFilter|DurationToMs|MsToDuration|ContainsAll|ExtractBits|GetDateTime|GetKeyValue|GetTimeZone|IsDirectory|IsPrintable|LeftJustify|ListPrepend|ListReplace|MdCodeBlock|ParseBinary|ReverseBits|RotateRight|SetKeyValue|Capitalize|Dictionary|ExpandTabs|FileExists|FormatJson|GetDayName|IsFunction|IsLessThan|IsNegative|IsNotEmpty|IsPositive|ListAppend|ListInsert|ListRemove|LookupItem|MatchesAll|MdEmphasis|ParseOctal|PrependStr|RemoveFile|ReplaceStr|ReverseStr|RightShift|RightStrip|RotateLeft|ShortenStr|SplitLines|StartsWith|StripNulls|LdapAttrGE|LdapAttrLE|LdapEscape|AppendStr|DefaultTo|EncodeUrl|Enumerate|FirstItem|GetMinute|GetSecond|GetValues|HexDecode|HexEncode|IsBetween|IsBoolean|IsDecimal|IsEqualTo|IsInteger|IsNotNone|IsNumeric|IsPattern|LeftShift|LeftStrip|MdHeading|MultiMode|ParseJSON|ParseYAML|PVariance|RemoveKey|StringLen|TitleCase|ToBoolean|ToggleBit|ToInteger|BaseName|CaseFold|Checksum|ClearBit|Contains|EndsWith|FloorDiv|GetMonth|IMatches|IsBitSet|IsFinite|IsNumber|IsString|LastItem|MdStrong|ParseCSV|ParseHCL|ParseHex|ParseINI|ParseInt|ParseUrl|RFindStr|RightStr|RIndexOf|SwapCase|ToBinary|ToNumber|ToString|Variance|ZeroFill|CountOf|FindStr|GetHour|GetKeys|GetYear|IndexOf|IsAlpha|IsAscii|IsDigit|IsEmpty|IsFalse|IsFloat|IsLower|IsNotIn|IsSpace|IsTitle|IsUpper|LeftStr|Matches|Reverse|SetBits|ToFloat|ToOctal|BitAnd|BitNot|BitXor|Center|DivMod|Format|GetDay|IsEven|IsFile|IsList|IsNone|IsTrue|IsZero|Length|MdCode|MdLink|Median|Negate|Plural|PStdev|RSplit|SetBit|SubStr|ToList|Unique|Apply|ASCII|BitOr|Clamp|Clone|Floor|IsInf|IsNan|IsOdd|Lower|Round|Slice|Split|Stdev|Strip|ToHex|Trunc|Upper|Ceil|Hash|IsIn|Item|Join|List|Mean|Mode|Pred|Repr|Sign|Sort|Succ|Type|Abs|Add|Chr|Div|Max|Min|Mod|Mul|Not|Ord|Pow|Sub|Sum|Id)(?=\s*\()", Name.Function),
        ]
    }
