...
_BUILT_IN_FUNCS: dict[str, Callable[..., Any]] = {
    ...
    "EndsWith":       poly_ends_with,
    "Enumerate":      poly_enumerate,
    "ExpandTabs":     poly_expand_tabs,
    ...
    "Id":             poly_id,
    "IndexOf":        poly_index_of,
    "IsAlpha":        poly_is_alpha,
    "IsAlphaNumeric": poly_is_alnum,
    "IsAscii":        poly_is_ascii,
    "IsBetween":      poly_is_between,
    "IsBitSet":       poly_is_bit_set,
    "IsBoolean":      poly_is_bool,
    "IsDecimal":      poly_is_decimal,
    "IsDictionary":   poly_is_dict,
    "IsDigit":        poly_is_digit,
    "IsDirectory":    is_dir,
    ...
    "IsLessThan":     poly_lt,
    "IsList":         poly_is_list,
    "IsLower":        poly_is_lower,
    "IsNan":          poly_is_nan,
    "IsNegative":     poly_is_negative,
    "IsNone":         poly_is_none,
    ...
    "IsNumeric":      poly_is_numeric,
    "IsOdd":          poly_is_odd,
    "IsPattern":      poly_is_pattern,
    "IsPositive":     poly_is_positive,
    "IsPrintable":    poly_is_printable,
    "IsSpace":        poly_is_space,
    "IsString":       poly_is_str,
    "IsTitle":        poly_is_title,
    "IsTrue":         poly_true,
    "IsUpper":        poly_is_upper,
    "IsZero":         poly_is_zero,
    "Item":           poly_get_item,
    "Join":           poly_join,
    ...
    "RemovePrefix":   poly_remove_prefix,
    "RemoveSuffix":   poly_remove_suffix,
    ...
    "Sort":           poly_sort,
    "Split":          poly_split,
    "SplitLines":     poly_split_lines,
    "StartsWith":     poly_starts_with,
    "Stdev":          poly_stdev,
