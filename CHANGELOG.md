...
- "Load" no longer sets the $load variable. Use the "Giving" option
  to place the metadata in a variable of your choosing.
- Readability of error messages generated by "Load" improved
- Reference section in Visual Studio Code side bar is now a tree
